...
Table~\ref{tab:main_results} presents benchmark results for the top performing models (underperforming models with CER $>$70\% omitted for clarity. see Section~\ref{sec:error_analysis}). 
\footnotesize
\begin{table}[tb]
\centering
