...
\textbf{CNN-CTC} achieves \ctcCacc\% char. acc.(\ctcCER\% CER).
...
\bottomrule
\end{tabular}\\[2mm]
\footnotesize{HF = HuggingFace, in-domain. Book = out-of-domain historical text.}
\end{center}
\vspace{1mm}
The best TrOCR degrades by \trocrSynthDeltaCER\,pp on historical
