...
\begin{frame}{What are S\'{a}mi languages \& Why this matters}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{itemize}
      ...
      % \item To me: low-resource Silesian language in southern Poland
...
\begin{frame}{Research question \& contributions}
  ...
  % \begin{enumerate}
  %   \item Lightweight CNN-CTC architecture for North S\'{a}mi OCR with sustainable footprint
  ...
  \begin{columns}[T,onlytextwidth]
   ...
   \item Sentences with over 80 characters have higher CER.\\[0.3em]
    ...
    OCR each segment, rejoin.
      ...
      % \item Statistically significant: $p = \splitPValue{}$, Cohen's $d = \splitCohensD{}$ (large effect)
